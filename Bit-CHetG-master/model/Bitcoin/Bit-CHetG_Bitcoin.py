...
def make_print_to_file(path='./'):
    ...
    fileName = datetime.datetime.now().strftime('TGCN+'+'%Y_%m_%d_%H-%M-%S')
...
tddroprate,"budroprate",budroprate,"datasetname",datasetname,"iterations",iterations)
